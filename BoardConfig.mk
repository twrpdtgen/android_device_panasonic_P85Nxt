...
DEVICE_PATH := device/panasonic/P85Nxt
...
TARGET_KERNEL_CONFIG := P85Nxt_defconfig
TARGET_KERNEL_SOURCE := kernel/panasonic/P85Nxt
...
BOARD_BOOTIMAGE_PARTITION_SIZE := 19047724
BOARD_RECOVERYIMAGE_PARTITION_SIZE := 19047724
